...
export class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        const f0 = this.gui.addFolder('Top Left Coords')
        ...
        const f1 = this.gui.addFolder('Top Right Coords')
        ...
        const f2 = this.gui.addFolder('Bottom Left Coords')
        ...
        const f3 = this.gui.addFolder('Bottom Right Coords')
