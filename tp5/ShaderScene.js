...
export class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.testShaders = [
			new CGFshader(this.gl, "shaders/flat.vert", "shaders/flat.frag"), // Flat shading
			new CGFshader(this.gl, "shaders/uScale.vert", "shaders/uScale.frag"), // Passing a scale as uniform
			new CGFshader(this.gl, "shaders/varying.vert", "shaders/varying.frag"), // Passying a varying VS -> FS
			new CGFshader(this.gl, "shaders/texture1.vert", "shaders/texture1.frag"), // Simple texturing
			new CGFshader(this.gl, "shaders/texture2.vert", "shaders/texture2.frag"), // Multiple textures in FS
